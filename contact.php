...
<style>
    ...
    /* Darken top of map so the transparent navbar stays legible */
    .contact-map-overlay {
        position: absolute;
        top: 0;
        left: 0;
    ...
    .tab-text span:first-child {
        transform: translateY(0);
    }

    .tab-text span:last-child {
        position: absolute;
        left: 0;
        top: 100%;
        width: 100%;
    ...
    .ctab.active .tab-text span:first-child {
        transform: translateY(-100%);
    }

    .ctab:hover .tab-text span:last-child,
    .ctab.active .tab-text span:last-child {
        transform: translateY(-100%);
    }
    ...
    .contact-btn:hover .btn-text span:first-child {
        transform: translateY(-100%);
    }

    .contact-btn:hover .btn-text span:last-child {
        transform: translateY(-100%);
    }
...
<script>
    ...
    const LOCATIONS = {
        canada: {
            lat: 49.190855244994,
            lng: -123.09196584383979,
            zoom: 15
        },
        newZealand: {
            lat: -37.78107668155766,
            lng: 175.27477627458572,
            zoom: 15
        },
        southAfrica: {
            lat: -33.86615866037444,
            lng: 18.51968491904271,
            zoom: 15
        },
        china: {
            lat: 36.47942755081035,
            lng: 120.49414140669232,
            zoom: 15
        }
    };
